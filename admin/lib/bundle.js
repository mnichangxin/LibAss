...
var ContextMenu = function (_React$Component) {
    ...
    _createClass(ContextMenu, [{
        ...
        value: function render() {
            ...
            var Menus = menus.map(function (item, index) {
                return _react2.default.createElement(
                    'li',
                    { className: _index2.default.menu, onClick: item.handler, key: index },
                    item.value
                );
            });
            ...
            return _react2.default.createElement(
                'ul',
                { className: _index2.default.menubox, style: { width: style.width } },
                Menus
            );
        }
    }]);
